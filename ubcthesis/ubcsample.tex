...
\title{Resilience of Machine Learning Applications against Hardware Faults}
\subtitle{from Safety and Security Perspective}
...
Whereas ranking the parameters by the heuristic $value/|grad|$ seems promising both with and without applying clipper as a protection technique as demonstrated in Figure \ref{heuristic_layers:all}, it turns out to be a proxy to identify the parameters which are in the last layer. If we plot the same measures excluding the injections to the parameters of the last layer as demonstrated in Figure \ref{heuristic_layers:wolast}, we will see that $|grad|$ will be a better heuristic after applying clipper protection. Nevertheless, $value/|grad|$ remains dominant if we don't protect the network. 

\begin{figure}[ht]
  \begin{center}
    \includegraphics[width=\columnwidth]{images/heuristic_protection:clipper_layers:all}
    \includegraphics[width=\columnwidth]{images/heuristic_protection:none_layers:all}
    \caption{\label{heuristic_layers:all}Performance of heuristics in comparison to random parameter selection. Including injections to all layers.}
  \end{center}
\end{figure}
...
\begin{figure}[ht]
  \begin{center}
    ...
    \includegraphics[width=\columnwidth]{images/heuristic_protection:clipper_layers:wolast}
   \includegraphics[width=\columnwidth]{images/heuristic_protection:none_layers:wolast}
    \caption{\label{heuristic_layers:wolast}Performance of heuristics in comparison to random parameter selection. Excluding the injections to the last layer.}
  \end{center}
\end{figure}
